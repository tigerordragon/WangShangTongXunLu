...
public class AdminControllerTest {
    ...
    @Test
    public void unapprovedStudentsContainPendingAndRejectedStudents() throws Exception {
        MockMvc mockMvc = createMockMvc();

        String unapproved = mockMvc.perform(get("/admin/students/unapproved"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse()
                .getContentAsString();
    ...
    private MockMvc createMockMvc() {
        ...
        studentRepository.save(new Student(2L, "student-b", "123456", AuditStatus.PENDING, 0, null,
                "computer science", "class one", 2022, "company-b", "hangzhou", "13800000001", "student-b@example.com"));
        studentRepository.save(new Student(3L, "student-c", "123456", AuditStatus.REJECTED, 0, null,
                "mathematics", "class two", 2023, "company-c", "beijing", "13800000002", "student-c@example.com"));
        studentRepository.save(new Student(4L, "student-d", "123456", AuditStatus.DISABLED, 0, null,
